...
<body>
	...
	<h4><b>Pemotongan dengan Biaya Bahan Baku</b></h4>
		<table class="table table-striped">
			...
			while ($row = mysqli_fetch_assoc($result)) {
				$kd = $row['kode_produk'];
				$bahan = mysqli_query($conn, "SELECT b.kebutuhan as kebutuhan, i.nama as nama, i.harga as harga from komponen_produk b join inventory i on b.kode_item=i.kode_item WHERE b.kode_produk = '$kd'");
