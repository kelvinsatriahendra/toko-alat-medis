...
<div class="container">
	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<?php 
			$result = mysqli_query($conn, "SELECT DISTINCT invoice, kode_customer, status, kode_produk, qty,terima,tolak, cek FROM pesanan group by invoice");
			$no = 1;
			$array = 0;
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="pesanan.php" class="btn btn-default">Close</a>
				</div>
			</div>
		</div>
	</div>
 ...
 ?>
	...
	<div class="row">
		<div class="col-md-4 bg-danger" style="padding:10px;">
			<h4>Kekurangan Item </h4>
			<h5 style="color: red;font-weight: bold;">Silahkan Tambah Stok Item dibawah ini : </h5>
			<table class="table table-striped">
				<tr>
					<th>No</th>
					<th>Item</th>
