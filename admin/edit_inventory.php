...
$result = mysqli_query($conn, "SELECT * FROM inventory WHERE kode_item = '$kode'");
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" disabled value="<?= $row['kode_item']; ?>">
					<input type="hidden" class="form-control" id="exampleInputEmail1" placeholder="Contoh : Kg atau gram" name="kd_material" value="<?= $row['kode_item']; ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
